...
Where the number came from: the fitting. Three is the highest number of sends any fitter needed, across one fitting that records it, and every fitting so far reports the same three. It is a measurement of somebody's room rather than a guess, which is why the number to reach for when presses get dropped is this one.
...
|---|---|---|---|---:|---|
| David | [@DAB-LABS](https://github.com/DAB-LABS) | 2026-07-30 | 0.9.0 | 3 | key `c821d7fff5adfa5c` |
